...
export default function CartContent() {
  ...
  if (cart.length === 0) {
    return (
      <div className="min-h-[80vh] flex flex-col items-center justify-center p-4 bg-cream text-center">
        <div className="w-32 h-32 bg-primary/5 rounded-full flex items-center justify-center mb-8 border-2 border-dashed border-primary/20 mx-auto">
          <span className="text-6xl">🍲</span>
        </div>
        <h2 className="text-3xl font-bold mb-4 text-gray-900">Your pot is empty</h2>
        <p className="text-gray-500 mb-10 max-w-sm font-medium opacity-80 mx-auto">The fire is ready, but you haven't added anything to your order yet.</p>
        <Link 
          href="/#menu" 
